...
> **Note:** The stsimcbmcfs3 package includes two template Libraries, **CBM-CFS3 Example** and **CBM-CFS3 CONUS**, that contain example inputs and outputs. Installation of R and the CBM-CFS3 Database are not required to view the template Libraries.
