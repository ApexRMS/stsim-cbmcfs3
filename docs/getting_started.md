...
Once all required programs are installed, open **SyncroSim** and select **File -> Packages... -> Install...** and select the **stsim**, **stsimsf**, and **stsimcbmcfs3** packages and click OK. Alternativelym download the <a href="https://github.com/ApexRMS/stsimcbmcfs3/releases" target="_blank">latest release</a> from GitHub. Open **SyncroSim** and select **File -> Packages... -> Install From File...**, then navigate to the downloaded pacjage file with the extension *.ssimpkg*.
...
<br>
>**Note:** Populated datasheets will appear at the top of the Datafeeds list with a green check in the Data field. 
...
<br>
<img align="middle" style="padding: 3px" width="850" src="assets/images/screencap-14.png">
<br>
