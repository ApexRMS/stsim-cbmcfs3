createCBMValidationScenario <- function(myLibraryDir, myLibraryName, myValidationScenarioName, crosswalkSF, crosswalkSUST, forestType, validationDataWide){
  # Crosswalk function
  ...
  myStateClassID <- STSim_StateClass[STSim_StateClass$Name==crosswalkSUST[1,"ST-Sim State Class"], "ID"]
  ...
  dbWriteTable(con, name="stsimsf_OutputStock", value=SF_OutputStock1, append=FALSE, overwrite=TRUE)
